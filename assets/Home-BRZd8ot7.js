import{u as Ne,j as v,L as Lt,R as Nt,r as Le}from"./index-CirMbOJN.js";import{m as Ot}from"./profiel-HT9mkQvT.js";const It="_App_10714_22",Ft="_header_10714_22",bt="_nav__mq_10714_1",wt="_active_10714_49",Bt="_menu_10714_52",Ct="_container__mq_10714_1",yt="_footer__mq_10714_1",Mt="_project__detail_10714_1",Yt="_contacts__inputs_10714_1",Xt="_contacts__wrapper_10714_1",Pt="_about__mq_10714_1",zt="_box_10714_135",Vt="_root_10714_1",Qt="_main_10714_161",Gt="_Light_10714_231",Ht="_Dark_10714_242",qt="_intro_10714_253",Wt="_container_10714_261",kt="_intro__content_10714_286",Jt="_intro__status_10714_325",Kt="_intro__status_box_10714_339",jt="_blink_10714_1",w={App:It,header:Ft,nav__mq:bt,active:wt,menu:Bt,container__mq:Ct,footer__mq:yt,project__detail:Mt,contacts__inputs:Yt,contacts__wrapper:Xt,about__mq:Pt,box:zt,root:Vt,main:Qt,Light:Gt,Dark:Ht,intro:qt,container:Wt,intro__content:kt,intro__status:Jt,intro__status_box:Kt,blink:jt},Zt=()=>{const{t:l}=Ne();return v.jsx(v.Fragment,{children:v.jsx("div",{className:w.intro,children:v.jsxs("div",{id:"container__mq",className:w.container,children:[v.jsxs("figure",{children:[v.jsx("img",{src:Ot,alt:"developer picture"}),v.jsxs("article",{className:w.intro__status,children:[v.jsxs("h5",{children:["Currently working on ",v.jsx("span",{children:"Portfolio"})]}),v.jsx("div",{className:w.intro__status_box})]})]}),v.jsxs("article",{className:w.intro__content,children:[v.jsxs("h5",{children:[l("Hi, I am a")," ",v.jsx("span",{children:l("web designer")})," ",l("and"),v.jsxs("span",{children:[" ",l("front-end developer")]})]}),v.jsx("p",{children:l("I craft responsive websites where technologies meet creativity")}),v.jsx("div",{className:w.intro__socials,children:v.jsx(Lt,{to:Nt.CONTACTS,children:v.jsxs("button",{children:["< ",l("Contact me")," />"]})})})]})]})})})};var c={SIM_RESOLUTION:128,DYE_RESOLUTION:1024,CAPTURE_RESOLUTION:512,DENSITY_DISSIPATION:1,VELOCITY_DISSIPATION:.2,PRESSURE:.8,PRESSURE_ITERATIONS:20,CURL:30,INITIAL:!0,SPLAT_AMOUNT:5,SPLAT_RADIUS:.25,SPLAT_FORCE:6e3,SPLAT_KEY:"Space",SHADING:!0,COLORFUL:!0,COLOR_UPDATE_SPEED:10,COLOR_PALETTE:[],HOVER:!0,BACK_COLOR:"#000000",TRANSPARENT:!1,BRIGHTNESS:.5,BLOOM:!0,BLOOM_ITERATIONS:8,BLOOM_RESOLUTION:256,BLOOM_INTENSITY:.8,BLOOM_THRESHOLD:.6,BLOOM_SOFT_KNEE:.7,SUNRAYS:!0,SUNRAYS_RESOLUTION:196,SUNRAYS_WEIGHT:1},W=[],ie=[],Y=!1,oe=!1,ne=!1,$t={splats(){W.push(Math.random()*c.SPLAT_AMOUNT*4+c.SPLAT_AMOUNT)},splat(l,F,B,x,_=void 0){ie.push([l,F,B,x,_])},screenshot(){ne=!0},pause(l=!1){Y?Y=!1:Y=!0,l?oe=!0:oe=!1},config(l){Object.assign(c,l)},simulation(l,F={}){Object.assign(c,F),xe();function B(){this.id=-1,this.texcoordX=0,this.texcoordY=0,this.prevTexcoordX=0,this.prevTexcoordY=0,this.deltaX=0,this.deltaY=0,this.down=!1,this.moved=!1,this.color=[30,0,300]}let x=[],_=[];x.push(new B);const{gl:t,ext:R}=Oe(l);R.supportLinearFiltering||(c.DYE_RESOLUTION=512,c.SHADING=!1,c.BLOOM=!1,c.SUNRAYS=!1);function Oe(e){const i={alpha:!0,depth:!1,stencil:!1,antialias:!1,preserveDrawingBuffer:!1};let r=e.getContext("webgl2",i);const o=!!r;o||(r=e.getContext("webgl",i)||e.getContext("experimental-webgl",i));let n,a;o?(r.getExtension("EXT_color_buffer_float"),a=r.getExtension("OES_texture_float_linear")):(n=r.getExtension("OES_texture_half_float"),a=r.getExtension("OES_texture_half_float_linear")),r.clearColor(0,0,0,1);const u=o?r.HALF_FLOAT:n.HALF_FLOAT_OES;let s,m,U;return o?(s=D(r,r.RGBA16F,r.RGBA,u),m=D(r,r.RG16F,r.RG,u),U=D(r,r.R16F,r.RED,u)):(s=D(r,r.RGBA,r.RGBA,u),m=D(r,r.RGBA,r.RGBA,u),U=D(r,r.RGBA,r.RGBA,u)),{gl:r,ext:{formatRGBA:s,formatRG:m,formatR:U,halfFloatTexType:u,supportLinearFiltering:a}}}function D(e,i,r,o){if(!Ie(e,i,r,o))switch(i){case e.R16F:return D(e,e.RG16F,e.RG,o);case e.RG16F:return D(e,e.RGBA16F,e.RGBA,o);default:return null}return{internalFormat:i,format:r}}function Ie(e,i,r,o){let n=e.createTexture();e.bindTexture(e.TEXTURE_2D,n),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texImage2D(e.TEXTURE_2D,0,i,4,4,0,r,o,null);let a=e.createFramebuffer();return e.bindFramebuffer(e.FRAMEBUFFER,a),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,n,0),e.checkFramebufferStatus(e.FRAMEBUFFER)==e.FRAMEBUFFER_COMPLETE}function Fe(){let e=M(c.CAPTURE_RESOLUTION),i=S(e.width,e.height,R.formatRGBA.internalFormat,R.formatRGBA.format,R.halfFloatTexType,t.NEAREST);Re(i);let r=be(i);r=we(r,i.width,i.height);let o=Be(r,i.width,i.height).toDataURL();Ce("fluid.png",o),URL.revokeObjectURL(o)}function be(e){t.bindFramebuffer(t.FRAMEBUFFER,e.fbo);let i=e.width*e.height*4,r=new Float32Array(i);return t.readPixels(0,0,e.width,e.height,t.RGBA,t.FLOAT,r),r}function we(e,i,r){let o=new Uint8Array(e.length),n=0;for(let a=r-1;a>=0;a--)for(let u=0;u<i;u++){let s=a*i*4+u*4;o[s+0]=X(e[n+0])*255,o[s+1]=X(e[n+1])*255,o[s+2]=X(e[n+2])*255,o[s+3]=X(e[n+3])*255,n+=4}return o}function X(e){return Math.min(Math.max(e,0),1)}function Be(e,i,r){let o=document.createElement("canvas"),n=o.getContext("2d");o.width=i,o.height=r;let a=n.createImageData(i,r);return a.data.set(e),n.putImageData(a,0,0),o}function Ce(e,i){let r=document.createElement("a");r.download=e,r.href=i,document.body.appendChild(r),r.click(),document.body.removeChild(r)}class ye{constructor(i,r){this.vertexShader=i,this.fragmentShaderSource=r,this.programs=[],this.activeProgram=null,this.uniforms=[]}setKeywords(i){let r=0;for(let n=0;n<i.length;n++)r+=Dt(i[n]);let o=this.programs[r];if(o==null){let n=T(t.FRAGMENT_SHADER,this.fragmentShaderSource,i);o=ue(this.vertexShader,n),this.programs[r]=o}o!=this.activeProgram&&(this.uniforms=ce(o),this.activeProgram=o)}bind(){t.useProgram(this.activeProgram)}}class d{constructor(i,r){this.uniforms={},this.program=ue(i,r),this.uniforms=ce(this.program)}bind(){t.useProgram(this.program)}}function ue(e,i){let r=t.createProgram();return t.attachShader(r,e),t.attachShader(r,i),t.linkProgram(r),!t.getProgramParameter(r,t.LINK_STATUS)&&console.trace(t.getProgramInfoLog(r)),r}function ce(e){let i=[],r=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let o=0;o<r;o++){let n=t.getActiveUniform(e,o).name;i[n]=t.getUniformLocation(e,n)}return i}function T(e,i,r){i=Me(i,r);const o=t.createShader(e);return t.shaderSource(o,i),t.compileShader(o),!t.getShaderParameter(o,t.COMPILE_STATUS)&&console.trace(t.getShaderInfoLog(o)),o}function Me(e,i){if(i==null)return e;let r="";return i.forEach(o=>{r+="#define "+o+`
